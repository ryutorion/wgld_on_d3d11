...
b8 D3D11Renderer::Update(float delta)
{
	...
	XMVECTOR d;
	CBModelVS worlds_vs[9]
	{
		XMMatrixTranslation(-6.25f,  2.0f, 0.0f),
		XMMatrixTranslation(-3.75f,  2.0f, 0.0f),
		XMMatrixTranslation(-1.25f,  2.0f, 0.0f),
		XMMatrixTranslation( 1.25f,  2.0f, 0.0f),
		XMMatrixTranslation( 3.75f,  2.0f, 0.0f),
		XMMatrixTranslation( 6.25f,  2.0f, 0.0f),
		XMMatrixTranslation(-2.50f, -2.0f, 0.0f),
		XMMatrixTranslation( 0.00f, -2.0f, 0.0f),
		XMMatrixTranslation( 2.50f, -2.0f, 0.0f),
	};
	CBModelPS worlds_ps[9] {};
	for(size_t i = 0; i < size(worlds_vs); ++i)
	{
		worlds_vs[i].W = XMMatrixRotationAxis(XMVectorSet(0.0f, 1.0f, 0.0f, 1.0f), rad) * worlds_vs[i].W;
		worlds_ps[i].IW = XMMatrixTranspose(XMMatrixInverse(&d, worlds_vs[i].W));
