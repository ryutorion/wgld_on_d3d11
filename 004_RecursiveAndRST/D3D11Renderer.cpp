...
b8 D3D11Renderer::Update(float delta)
{
	...
	XMMATRIX worlds[3]
	{
		XMMatrixTranspose(XMMatrixTranslation(c, s + 1.0f, 0.0f)),
		XMMatrixTranspose(XMMatrixRotationY(rad) * XMMatrixTranslation(1.0f, -1.0f, 0.0f)),
		XMMatrixTranspose(XMMatrixScaling(s + 1.0f, s + 1.0f, 0.0f) * XMMatrixTranslation(-1.0f, -1.0f, 0.0f)),
	};
